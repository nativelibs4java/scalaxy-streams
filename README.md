...
* 0.4-SNAPSHOT
  * ...
  * Added `js.Array` & `js.ArrayOps` sources (for [Scala.js](www.scala-js.org). Did you know Scalaxy/Stream is included in their [Scala.js Fiddle](http://www.scala-js-fiddle.com/)?)
  * Added `flatten` op
  * Added `take`, `drop` ops
  * Added `mkString` op
